...
class Printspreviewblocks extends React.Component {
  state = {
    open: false,
    imgid: '5d4ab469848c2113381b848b',
  ...
  render() {
    const { id, open, imgid, opsectionid, titlepage, subtext_1, subtext_2, subtext_3, button_1, url_btn_1, button_2, url_btn_2, url } = this.state;
    ...
    return (
      ...
      <PrintspreviewblocksForm handleChange={this.handleChange}
                  ...
                  selectedValue={{ id, open, imgid, opsectionid, titlepage, subtext_1, subtext_2, subtext_3, button_1, url_btn_1, button_2, url_btn_2, url }}
